...
clever_covaraite_hazards_func_s1_smaller_than_s2_update<-function(s1,s2,u,tt1,tt2,delt1,delt2,
  ...
  if(s1<u & u<=s2){
    ...
    if(tt2>=u & tt1>s1 & tt1<u & delt1==1){
      ...
      prob_nume_E_20<-1
      prob_nume_E_20<-prob_nume_E_20*product_integral_func_update(start=u,end=s2,1,1,tt1,
                                                                   basis_list_N2_select_update,coef_N2_initial_update,
                                                                   A1_time_grid,basis_list_A1_select,coef_A1,
                                                                   A2_time_grid,basis_list_A2_select,coef_A2,
                                                                   N1_time_grid,basis_list_N1_select,coef_N1,
                                                                   ...
                                                                   delt1,delt2,
                                                                   grid_scale_clever_covariate,
                                                                    type=ifelse(!reverse,"N2","N1"))

      E_20<-prob_nume_E_20/prob_denom_E_20


      hazard_N1<-0
      hazard_N2<-hazard_func_update(u,1,1,tt1,basis_list_N2_select_update,coef_N2_initial_update,
                                     A1_time_grid,basis_list_A1_select,coef_A1,
                                     A2_time_grid,basis_list_A2_select,coef_A2,
                                     N1_time_grid,basis_list_N1_select,coef_N1,
                                     N2_time_grid,basis_list_N2_select,coef_N2,
    ...
    if(tt2>=u & tt1>=u){
      ...
      prob_nume_E_20_part2<-prob_nume_E_20_part2*product_integral_func_update(start=u,end=s2,0,0,0,
                                                                               basis_list_N1_select_update,coef_N1_initial_update,
                                                                               A1_time_grid,basis_list_A1_select,coef_A1,
                                                                               A2_time_grid,basis_list_A2_select,coef_A2,
                                                                               N1_time_grid,basis_list_N1_select,coef_N1,
      ...
      if(u<s2){
        ...
        left_point_eval<-sapply(seq_temp[-length(seq_temp)],function(x){
          hazard_func_update(x,0,0,0,basis_list_N1_select_update,coef_N1_initial_update,
                             A1_time_grid,basis_list_A1_select,coef_A1,
                             A2_time_grid,basis_list_A2_select,coef_A2,
                             N1_time_grid,basis_list_N1_select,coef_N1,
                             N2_time_grid,basis_list_N2_select,coef_N2,
                             ...
                             grid_scale_clever_covariate,
                             type=ifelse(!reverse,"N1","N2"))*
            product_integral_func_update(start=u,end=x,0,0,0,
                                         basis_list_N1_select_update,coef_N1_initial_update,
                                         A1_time_grid,basis_list_A1_select,coef_A1,
                                         A2_time_grid,basis_list_A2_select,coef_A2,
                                         N1_time_grid,basis_list_N1_select,coef_N1,
            ...
            product_integral_func_update(start=u,end=x,0,0,0,
                                         ...
                                         grid_scale_clever_covariate,
                                         type=ifelse(!reverse,"N2","N1"))*
            product_integral_func_update(start=x,end=s2,1,1,x,
                                         basis_list_N2_select_update,coef_N2_initial_update,
                                         A1_time_grid,basis_list_A1_select,coef_A1,
                                         A2_time_grid,basis_list_A2_select,coef_A2,
                                         N1_time_grid,basis_list_N1_select,coef_N1,
      ...
      hazard_N1<-hazard_func_update(u,0,0,0,basis_list_N1_select_update,coef_N1_initial_update,
                                    A1_time_grid,basis_list_A1_select,coef_A1,
                                    A2_time_grid,basis_list_A2_select,coef_A2,
                                    N1_time_grid,basis_list_N1_select,coef_N1,
                                    N2_time_grid,basis_list_N2_select,coef_N2,
                                    ...
                                    grid_scale_clever_covariate,
                                    type=ifelse(!reverse,"N1","N2"))
      hazard_N2<-hazard_func_update(u,0,0,0,basis_list_N2_select_update,coef_N2_initial_update,
                                    A1_time_grid,basis_list_A1_select,coef_A1,
                                    A2_time_grid,basis_list_A2_select,coef_A2,
                                    N1_time_grid,basis_list_N1_select,coef_N1,
                                    N2_time_grid,basis_list_N2_select,coef_N2,
    ...
    if(tt2>=u & tt1>=u){
      ...
      prob_nume_E_11<-1
      prob_nume_E_11<-prob_nume_E_11*product_integral_func_update(start=u,end=s2,1,1,u,
                                                                   basis_list_N2_select_update,coef_N2_initial_update,
                                                                   A1_time_grid,basis_list_A1_select,coef_A1,
                                                                   A2_time_grid,basis_list_A2_select,coef_A2,
                                                                   N1_time_grid,basis_list_N1_select,coef_N1,
...
clever_covaraite_hazards_func_update<-function(s1,s2,u,tt1,tt2,delt1,delt2,
                                               A1_time_grid,basis_list_A1_select,coef_A1,
                                               A2_time_grid,basis_list_A2_select,coef_A2,
                                               N1_time_grid,basis_list_N1_select,coef_N1,
                                               N2_time_grid,basis_list_N2_select,coef_N2,
  ...
  if(s1<=s2){
    result<-clever_covaraite_hazards_func_s1_smaller_than_s2_update(s1,s2,u,tt1,tt2,delt1,delt2,
                                                                    A1_time_grid,basis_list_A1_select,coef_A1,
                                                                    A2_time_grid,basis_list_A2_select,coef_A2,
                                                                    N1_time_grid,basis_list_N1_select,coef_N1,
                                                                    N2_time_grid,basis_list_N2_select,coef_N2,
    ...
    result<-clever_covaraite_hazards_func_s1_smaller_than_s2_update(s2,s1,u,tt2,tt1,delt2,delt1,
                                                                    A2_time_grid,basis_list_A2_select,coef_A2,
                                                                    A1_time_grid,basis_list_A1_select,coef_A1,
                                                                    N2_time_grid,basis_list_N2_select,coef_N2,
                                                                    N1_time_grid,basis_list_N1_select,coef_N1,
